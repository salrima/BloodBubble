  ...
  <?php
      ...
      if($_SERVER['REQUEST_METHOD'] == "POST"){
          if(isset($_POST['save']))
          {
            ...
            $sql="UPDATE `bloodbank` SET `bb_name`='$bbname',`Username`='$uname',`h_name`='$hname',`contactno`='$contactno',`contactperson`='$contactp',`email`='$email',`City`='$city',`District`='$district',`State`='$state' WHERE `bloodbank_id`='$bid';";
  ...
  <div class="container " style="background-color:gray; opacity:95%">
    ...
    <form action="updatebb.php" method="post"><br>
      <div class="row g-3 align-items-center">
        ...
        <div class="col-auto">
          <input type="text" name="bbname" id="bbname" value="<?php echo $row['bb_name'];?>" class="form-control"
            required>
        </div>
        <div class="col-auto">
        ...
        <div class="col-auto">
          <input type="username" name="uname" id="uname" value="<?php echo $row['Username'];?>" class="form-control"
            required>
        </div>
      </div><br><br>
      <div class="row g-3 align-items-cente">
        ...
        <div class="col-auto">
          <input type="text" name="contactp" id="contactp" value="<?php echo $row['contactperson'];?>"
