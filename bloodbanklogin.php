...
<header>
  ...
  <div class="col-auto">
    <input type="bbname" name="bbname" id="bbname" class="form-control" required >
  </div>
  <div class="col-auto">
    <label for="uname" class="col-form-label">User name</label>
  </div>
  <div class="col-auto">
    <input type="uname" name="uname" id="uname" class="form-control"required >
  </div>
  <div class="col-auto">
...
<div class="row g-3 align-items-center">
  ...
  <div class="col-auto">
    <input type="hname" name="hname" id="hname" class="form-control" required>
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
    <input type="contactp" name="contactp" id="contactp" class="form-control" required >
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
    <input type="contactno" name="contactno" id="contactno" class="form-control" required >
  </div>
    </div><br><br>
  <div class="mb-3">
