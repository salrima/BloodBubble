...
<head>
    ...
    <link rel="stylesheet" href="INDEXSAL.css">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <li style="list-style:circle;color:red;">You can donate blood every 56 days and we encourage you to donante as often as possible.</li>
                        <li style="list-style:circle;color:red;">If you donate whole blood, you need to wait 56 days between donations possibly longer, depending on the policy of your blood bank.</li>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <li style="list-style:circle;color:red;">This Day is commemorated to spread awareness about the requirement about blood to save a lot of lives of the people.</li>
                        <li style="list-style:circle;color:red;">The main objective of this Day is to create awareness of the importance of human blood.</li>
                        <li style="list-style:circle;color:red;">The World Blood Donor Day is celebrated on the birth anniversary of a Nobel Prize scientist Karl Landsteiner.</li>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Last updated 3 mins ago</small>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <li style="list-style:circle;color:red;">More than 1 million people every year are diagnosed with cancer for the first time. Many of them will need blood sometimes daily during chemotherapy.</li>
                        <li style="list-style:circle;color:red;">More than 38,000 blood donations are needed every day.</li>
                        <li style="list-style:circle;color:red;">Type O-negative whole blood can be transfused to people with any blood type,but this type of blood is rare,and supplies of it are low.</li>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Last updated 3 mins ago</small>
                    </div>
